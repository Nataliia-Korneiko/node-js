...
const sgMail = require('@sendgrid/mail') // устанавливаем на верхнем уровне, чтобы использовать во все controllers
...
sgMail.setApiKey(process.env.SENDGRID_API_KEY) // для user.controller.js и доругих controlsers
