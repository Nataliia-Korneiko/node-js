...
let app // для тестов user.controller.i.test.js

start()

function start() {
  // const app = initServer() // для использования app в других функциях
  app = initServer() // для тестов user.controller.i.test.js
...
module.exports = app // для тестов user.controller.i.test.js
